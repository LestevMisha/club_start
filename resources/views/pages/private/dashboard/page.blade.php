<div class="grid" id="flexGridify" class="flexGridify flexGridify-init">
    ...
    <div class="grid-item">
        <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
            <div class="flex h align space-btw mb-1">
                <div class="b-text b-text_fith b-text_grey b-text_600 modeLight_darker"> {{ __('pages/private/dashboard.1') }}</div>
            ...
            <div class="flex gap v">
                <div class="flex v gap_05">
                    <x-modern-copy-input.compiled :uid="uniqid()" :inscription="__('pages/private/dashboard.19')" attribute="klub-link" value="https://t.me/+UChE4Obnlq9iNmFh" color="orange" />
    ...
    <div class="grid-item">
        <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
            @if (!app('App\Services\BladeServices')->hasCardVerification())
                <div class="flex h align space-btw mb-1">
                    <div class="b-text b-text_fith b-text_grey b-text_600 modeLight_darker">{{ __('pages/private/dashboard.8') }}</div>
                    <div class="drag-handler">
                        @svg('draggable-dots', 'move-icon')
                    </div>
                </div>
            ...
            @else
                <div class="flex h align space-btw mb-1">
                    <div class="b-text b-text_grey b-text_600 modeLight_darker">{{ __('pages/private/dashboard.28') }}</div>
                    <div class="drag-handler">
                        @svg('draggable-dots', 'move-icon')
                    </div>
                </div>
                <div class="flex v gap">
                    <div class="flex v gap_05">
                        ...
                        <x-modern-copy-input.compiled :uid="uniqid()" :inscription="__('pages/private/dashboard.20')" attribute="referral-link" value="{{ $url }}" color="orange" />
                        <div class="b-text b-text_08 b-text_400 b-text_grey-dark b-text_grey-dark-to-grey_light-mode">
    ...
    @if (app('App\Services\BladeServices')->hasCardVerification())
        <div class="grid-item">
            <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
                <div class="flex h align space-btw mb-1">
                    <div class="b-text b-text_grey b-text_600 modeLight_darker">{{ __('pages/private/dashboard.32') }}</div>
                    <div class="drag-handler">
                        @svg('draggable-dots', 'move-icon')
                    </div>
                </div>
                <div class="flex v gap">
                    <div class="flex h gap_05 mob">
                        <x-modern-field.compiled :uid="uniqid()" :inscription="__('pages/private/dashboard.30')" attribute="subscribers" value="0" color="green" />
                        <x-modern-field.compiled :uid="uniqid()" :inscription="__('pages/private/dashboard.31')" attribute="referred-partners" value="0" color="blue" />
    ...
    <div id="js-chart-item" class="grid-item" data-locale="{{ app()->getLocale() }}" data-legend-label="{{ __('pages/private/dashboard.18') }}" data-visitor-data='{!! json_encode(app('App\Services\BladeServices')->getVisitorData(), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) !!}'>
        <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
            <div class="flex h align space-btw mb-1">
                <div class="b-text b-text_fith b-text_grey">{{ __('pages/private/dashboard.11') }}</div>
                <div class="drag-handler">
                    @svg('draggable-dots', 'move-icon')
                </div>
            </div>
    ...
    <div class="grid-item">
        <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
            <div class="flex h align space-btw mb-1">
                <div class="b-text b-text_grey b-text_600 modeLight_darker">{{ __('pages/private/dashboard.12') }}</div>
                <div class="drag-handler">
                    @svg('draggable-dots', 'move-icon')
                </div>
            </div>
        ...
        <div class="flex v h100 w100 ds-row mob grid-stack-item-content">
            <div class="flex v">
                <div class="flex h align space-btw">
                    <div class="b-text b-text_grey b-text_600 modeLight_darker">{{ __('pages/private/dashboard.24') }}</div>
                    <div class="drag-handler">
                        @svg('draggable-dots', 'move-icon')
                    </div>
                </div>
