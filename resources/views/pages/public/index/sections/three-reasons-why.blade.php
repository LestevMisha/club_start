...
<section class="dark:bg-[#080808] relative -top-28 m-0 -mb-28 h-full w-full overflow-hidden rounded-[100%_100%_0_0_/_6rem_6rem_0_0] bg-white p-0 pt-20 z-30">
    <div class="min-w-96 max-w-96 relative z-10 m-auto w-full xl:max-w-[1200px]">
        ...
        <div class="relative flex h-fit w-full flex-col">
            <div class="flex flex-col">
                ...
                <div class="relative dark:bg-[#79797921] flex flex-col gap-8 rounded-3xl bg-[#e8e8e869] p-8 noise-before">
                    <img id="js-banknote" src="{{ URL::asset('assets/images/min-png/money-sticker.png') }}"
                        class="absolute -left-14 top-0 h-32 w-32 scale-x-[-1] opacity-20 [rotate:20deg] [transition:opacity_.225s_ease-in-out]" alt="banknote" loading="lazy">
                    <!-- Stopp09_er -->
                    <div class="flex flex-col gap-8 xl:flex-row">
                        <div class="flex w-full flex-col gap-8 xl:w-1/2">
                            <div class="flex flex-col">
                                <div class="mb-8 flex flex-col justify-between gap-8 xl:gap-4 xl:flex-row">
                                ...
                                <input type="range" min="200" max="1000" value="200"
                                    class="slider-thumb-sneaker h-2.5 w-full appearance-none rounded-[0.3rem] bg-[#d3d3d3] outline-[none] [transition:opacity_.2s]" id="subs">
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="range" min="1000" max="5000" value="1000"
                                    class="slider-thumb-sneaker h-2.5 w-full appearance-none rounded-[0.3rem] bg-[#d3d3d3] outline-[none] [transition:opacity_.2s]" id="add-price">
                            </div>
                        </div>
                        <div class="flex w-full flex-col gap-8 xl:w-1/2">
                            <div class="dark:text-white relative text-xl font-light text-black">
    ...
    <div class="noise"></div>
    <div class="dark:bg-[linear-gradient(180deg,_#00000000,_#000000)] absolute h-80 bottom-0 left-0 right-0 z-0 bg-[linear-gradient(180deg,_#00000000,_#FFFFFF)]"></div>
</section>
