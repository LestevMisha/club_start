            ...
            <div class="flex w-full flex-col gap-4 xl:w-1/2">
                ...
                <div class="js-accordion-item noise-before relative rounded-2xl bg-[#00000008] p-6 backdrop-blur-[2rem] backdrop-filter">
                    <button class="js-accordion-button group/button peer/button flex w-full flex-row gap-4">
                        <div class="align flex flex-row">
                            <span
                                class="js-accordion-text dark:text-white relative text-left text-2xl font-semibold text-black xl:text-3xl">
                ...
                <div class="js-accordion-item noise-before relative rounded-2xl bg-[#00000008] p-6 backdrop-blur-[2rem] backdrop-filter">
                    ...
                    <div class="flex overflow-x-scroll max-h-0 flex-col overflow-hidden opacity-0 [transition:all_.225s_ease-in-out] peer-[.expanded]/button:max-h-[100rem] peer-[.expanded]/button:opacity-100">
                        <div class="relative my-1 text-xl font-light text-[#acacac]">
                            {{ __('pages/public/index.147') }}
                        </div>
                        <audio class="h-12 mt-4" controls preload="none">
