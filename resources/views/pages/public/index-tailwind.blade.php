...
@section('sub-content')
    <main>
        {{-- 1. Main View --}}
        <section class="dark:bg-[linear-gradient(97deg,_#000000_40%,_#0d6efd_100%)] relative m-0 h-full w-full overflow-visible bg-white bg-[linear-gradient(97deg,_#FFFFFF_60%,_#0d6efd_100%)] p-0 py-48">
            <div class="min-w-80 max-w-96 relative z-10 m-auto w-full xl:max-w-[1280px]">
                <div class="flex flex-col-reverse xl:flex-row">
                    <div class="z-30 mb-24 flex w-full flex-col xl:w-[70%]">

                        <div
                            class="dark:border-[#ffffff33] dark:bg-[linear-gradient(0.303turn,_#ffffff_1%,_#00000000_100%)] relative mx-auto my-0 !mb-4 h-[fit-content] w-[fit-content] rounded-[1.5em] border-[0.1em] border-solid border-[#00000033] bg-[linear-gradient(0.303turn,_#000000_1%,_#00000033_100%)] bg-clip-text px-[1.5em] py-[0.6em] text-base font-medium uppercase text-transparent backdrop-blur-lg xl:m-0">
                        ...
                        <div class="dark:text-white relative mb-8 text-center text-2xl font-normal text-black xl:text-left">
                        ...
                        <div class="flex flex-col items-center gap-4 xl:flex-row">
                            <a class="group relative flex h-20 w-full cursor-pointer items-center justify-center rounded-2xl bg-[#0d6efde6] text-xl text-white no-underline [transition:all_0.225s_ease-in-out] hover:scale-105 hover:bg-[#0d6efd] xl:w-1/2"
                                ...
                                <img class="absolute -bottom-7 -right-4 h-[2.5em] w-[2.5em] opacity-0 [transition:all_0.225s_ease-in-out] group-hover:-translate-x-4 group-hover:-translate-y-4 group-hover:opacity-100"
                                    src="{{ URL::asset('assets/images/finger-click.png') }}" alt="finger-click">
                            </a>

                            <div class="flex flex-row items-center">
                                @svg('dynamic-premium.star-dynamic-premium', 'w-16 h-16')
                                <div class="text-nowrap dark:text-[#acacac] relative text-base font-normal text-[#666666]">
                                    {!! __('pages/public/index.7') !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex h-64 w-full flex-col sm:h-56 xl:h-auto xl:w-[30%]">
                        ...
                        <img class="pointer-events-none absolute -bottom-1/4 left-1/2 top-4 h-56 w-56 -translate-x-1/2 select-none overflow-visible [rotate:-22.5deg] sm:top-[unset] xl:left-[17%] xl:!min-h-[30rem] xl:!min-w-[30rem] xl:translate-x-0"
                            src="{{ URL::asset('assets/images/min-png/shipping-box.png') }}" alt="shipping-box">
                        <img class="pointer-events-none absolute -bottom-1/4 left-1/2 top-4 z-20 h-56 w-56 -translate-x-1/2 select-none overflow-visible [rotate:-22.5deg] sm:top-[unset] xl:left-[17%] xl:!min-h-[30rem] xl:!min-w-[30rem] xl:translate-x-0"
        ...
        {{-- 2. Offer (pros and cons) --}}
        <section class="dark:bg-black relative m-0 h-full w-full overflow-visible bg-white p-0 py-8">
            <div class="min-w-80 max-w-96 relative z-10 m-auto w-full pb-8 xl:max-w-[1200px]">
                <div class="mb-12 flex h-fit flex-col items-center justify-center">
                    <div class="dark:text-white relative w-fit text-center text-[2.5rem] font-bold uppercase text-black">
                        ...
                        <br />
                        <span class="relative w-fit text-center text-4xl font-normal uppercase text-[#acacac]">
                    ...
                    <div class="flex flex-col gap-6 xl:flex-row">
                        <div class="xl:-1/2 flex w-full flex-row items-start xl:items-baseline">
                            <div class="dark:text-white relative mr-8 text-4xl font-bold text-black">
                                <span class="dark:bg-[#0d6efd] absolute -left-4 top-[0.3rem] -z-10 mx-4 my-[0] h-9 w-9 rounded-[2rem] bg-[#c6d8ff] font-bold"></span>
                                1
                            </div>
                            <div class="dark:text-white relative text-xl font-normal text-black">
                ...
                <div class="mt-8 flex flex-col-reverse gap-8 xl:flex-row">
                    <div
                        ...
                        <div class="my-4 flex flex-col gap-4">
                            <div class="flex flex-row">
                                <div class="text-nowrap relative font-normal text-white">0 {{ __('pages/public/index.19') }}</div>
                                <span class="border-dot [border-bottom:0.1rem_dotted_#a9a9a9 mx-4 w-full"></span>
                                <div class="text-nowrap relative font-normal text-white">{{ __('pages/public/index.20') }}</div>
                            </div>
                            <div class="flex flex-row justify-between">
                                <div class="text-nowrap relative font-normal text-white">0 {{ __('pages/public/index.19') }}</div>
                                <span class="border-dot mx-4 w-full [border-bottom:0.1rem_dotted_#a9a9a9]"></span>
                                <div class="text-nowrap relative font-normal text-white">{{ __('pages/public/index.21') }}</div>
                            </div>
                            <div class="flex flex-row justify-between">
                                <div class="text-nowrap relative font-normal text-white">0 {{ __('pages/public/index.19') }}</div>
                                <span class="border-dot mx-4 w-full [border-bottom:0.1rem_dotted_#a9a9a9]"></span>
                                <div class="text-nowrap relative font-normal text-white">{{ __('pages/public/index.22') }}</div>
                            </div>
                            <div class="flex flex-row justify-between">
                                <div class="text-nowrap relative font-normal text-white">6 000 {{ __('pages/public/index.19') }}</div>
                                <span class="border-dot mx-4 w-full [border-bottom:0.1rem_dotted_#a9a9a9]"></span>
                                <div class="text-nowrap relative font-normal text-white">{{ __('pages/public/index.23') }}</div>
                            </div>
                        </div>
                        <a class="group/button relative flex h-20 w-full cursor-pointer items-center justify-center rounded-2xl bg-[#ffffffe6] text-xl text-black no-underline [transition:all_0.225s_ease-in-out] hover:scale-105 hover:bg-[#ffffff]"
                            href="{{ route('auth.register') }}">
                            {{ __('pages/public/index.6') }}
                            <img class="absolute -bottom-7 -right-4 h-[2.5em] w-[2.5em] opacity-0 [transition:all_0.225s_ease-in-out] group-hover/button:-translate-x-4 group-hover/button:-translate-y-4 group-hover/button:opacity-100"
                                src="{{ URL::asset('assets/images/finger-click.png') }}" alt="finger-click">
                        </a>
                        <img src="{{ URL::asset('assets/images/min-png/thumb-up.png') }}" class="b-img b-img_v4 group-hover/card:opacity-100" alt="thumb-up" loading="lazy">
                    </div>
                    <div
