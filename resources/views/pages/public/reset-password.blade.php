                            ...
                            <form id="js-reset-password-form" class="modern-form">
                                ...
                                <div class="flex v w100">
                                    <div class="flex v gap">
                                        ...
                                        <x-modern-password-input.compiled :uid="uniqid()" attribute="password_confirmation" inscription="Введите пароль еще раз" />
        ...
        (() => {
            ...
            form.addEventListener("submit", async (event) => {
                ...
                const {
                    success,
                    errors
                } = await reCAPTCHA('{{ config('services.google.recaptcha.site_key') }}', contentType, loader);
