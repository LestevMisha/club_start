<xside-menu class="side-container" data-uid="{{ $uid }}" data-js-initialized="false" data-attribute="{{ $attribute }}">
    ...
    <a class="{{ $route === 'private.dashboard' ? 'active' : '' }} group mx-4 flex w-full min-w-[14em] flex-row items-center gap-4" href="{{ route('private.dashboard') }}">
        ...
        <div
            class="dark:text-[#444444] dark:hover:text-[#666666] text-base font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666] group-[.active]:text-[#0d6efd]">
    ...
    <div class="mx-4 flex w-full min-w-[14em] flex-row items-center gap-4">
        ...
        <div id="js-logout-trigger"
            class="dark:text-[#444444] dark:hover:text-[#666666] cursor-pointer text-base font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666]">
    ...
    <a class="mx-4 flex w-full min-w-[14em] flex-row items-center gap-4" href="{{ route('public.index') }}">
        ...
        <div class="dark:text-[#444444] dark:hover:text-[#666666] text-base font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666]">
        ...
        <div class="flex w-full flex-row items-center gap-4">
            ...
            <div class="flex w-full flex-col">
                ...
                <div id="js-docs-content" class="ease-[cubic-bezier(1, .47, .2, .85)] ml-2 flex h-0 w-full flex-col justify-center gap-1 overflow-hidden transition-all duration-[525ms]">
                    <a class="dark:text-[#444444] dark:hover:text-[#666666] text-[0.8rem] font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666]" target="_blank" href="{{ route('public.public-offer') }}">
                        {{ __('components/side-menu.9') }}
                    </a>
                    <a class="dark:text-[#444444] dark:hover:text-[#666666] text-[0.8rem] font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666]" target="_blank" href="{{ route('public.privacy') }}">
                        {{ __('components/side-menu.10') }}
                    </a>
                    <a class="dark:text-[#444444] dark:hover:text-[#666666] text-[0.8rem] font-medium text-[#acacac] transition-colors duration-[.225s] ease-in-out hover:text-[#666666]" target="_blank" href="{{ route('public.terms') }}">
