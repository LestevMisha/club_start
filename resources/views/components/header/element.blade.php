<xheader
    ...
    <div class="mx-auto flex w-full flex-row justify-between">
        <div class="flex w-fit flex-row items-center rounded-none p-0 xl:rounded-2xl xl:bg-[#ffffff1f] xl:p-2 xl:backdrop-blur-lg xl:dark:bg-[#0000001f]">
        ...
        <div class="flex w-fit flex-col items-end gap-4 rounded-none p-0 pr-4! sm:flex-row sm:items-center xl:rounded-2xl xl:bg-[#ffffff1f] xl:p-2 xl:backdrop-blur-lg xl:dark:bg-[#0000001f]">
