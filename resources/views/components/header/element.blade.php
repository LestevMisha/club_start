<xheader
    class="dark:bg-[#00000087] min-w-96 fixed left-0 right-0 top-0 z-[101] mx-auto my-0 flex w-full max-w-[1200px] flex-col bg-[#ffffff1f] p-4 after:absolute after:left-0 after:top-0 after:-z-10 after:h-full after:w-full after:content-normal after:backdrop-blur-lg xl:!bg-transparent xl:px-0 xl:py-6 xl:after:backdrop-blur-0"
    data-uid="{{ $uid }}">
