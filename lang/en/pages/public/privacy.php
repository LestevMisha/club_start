...
This personal data processing policy has been drawn up in accordance with the requirements of the Federal Law of July 27, 2006. No. 152-FZ “On Personal Data” (hereinafter referred to as the Law on Personal Data) and determines the procedure for processing personal data and measures to ensure the security of personal data. They are undertaken by I.P. Shkitov Daniil Alekseevich (hereinafter - Operator).
TEXT,
...
1.2. This Operator’s policy regarding the processing of personal data (hereinafter referred to as the Policy) applies to all information that the Operator can receive about visitors to the site https://klubstart.com/.
TEXT,
...
2.3. The site is a collection of graphic and information materials, as well as computer programs and databases that ensure their availability on the Internet at the network address https://klubstart.com/.
TEXT,
...
2.8. Personal data - any information relating directly or indirectly to a specific or identified User of the site https://klubstart.com/.
TEXT,
...
2.10. User - any visitor to the site https://klubstart.com/.
TEXT,
...
5.8. There is no transfer of personal data when the user receives promotional codes, coupons or other promotions and discounts on third-party resources.
TEXT,
...
6.1. The processing of personal data is carried out with the consent of the subject of personal data to the processing of his personal data.
TEXT,
"key_918e431520d543eb2f5b7559e5a7bd6d" => <<<TEXT
6.2. The processing of personal data is necessary to achieve the goals provided for by an international treaty of the Russian Federation or law, to implement the functions, powers and responsibilities assigned by the legislation of the Russian Federation to the operator.
TEXT,
...
6.5. The processing of personal data is necessary to exercise the rights and legitimate interests of the operator or third parties or to achieve socially significant goals, provided that the rights and freedoms of the subject of personal data are not violated.
TEXT,
"key_3c557274c59d9c4356930e04b9ebc2ec" => <<<TEXT
6.6. The processing of personal data is carried out, access to an unlimited number of persons is provided by the subject of personal data or at his request (hereinafter referred to as publicly available personal data).
TEXT,
"key_5f7e4b789d75fa9714eb7ce7a6596d04" => <<<TEXT
6.7. We process personal data that is subject to publication or mandatory disclosure in accordance with federal law.
TEXT,
...
7.1. The operator ensures the safety of personal data and takes all possible measures to prevent access to personal data by unauthorized persons.
TEXT,
...
7.3. If inaccuracies in personal data are identified, the User can update them independently by sending a notification to the Operator to the Operator's email address danya.shkitov@bk.ru with the note "Updating personal data."
TEXT,
"key_e2464a4dd8ee5f72a192436daeadf076" => <<<TEXT
7.4. The period for processing personal data is determined by the achievement of the purposes for which the personal data were collected, unless a different period is provided for by the contract or current legislation.
TEXT,
"key_dd0d6ffc71f365cfec2d95f5aa0c0ae4" => <<<TEXT
The User may at any time withdraw his consent to the processing of personal data by sending a notification to the Operator via email to the Operator's email address danya.shkitov@bk.ru with the note "Withdrawal of consent to the processing of personal data."
TEXT,
...
7.8. When delivering goods, the Operator can collect data about the final delivery point and recipient in order to accurately calculate the route. Cargo transportation is carried out using transport companies and courier delivery services. Prices are based on carrier tariffs depending on the volume and weight of the cargo, as well as the distance from the point of departure.
TEXT,
...
8.1. The operator collects, records, systematizes, accumulates, stores, refines (updates, changes), extracts, uses, transfers (distribute, provide, access), depersonalizes, blocks, deletes and destroys personal data.
TEXT,
"key_6f1aac3a4536ebe5a6cce45b865e62a2" => <<<TEXT
8.2. The operator carries out automated processing of personal data with or without receiving and/or transmitting the received information via information and telecommunication networks.
TEXT,
...
9.2. Before submitting the above notification, the operator is obliged to obtain relevant information from the authorities of a foreign state, foreign individuals, foreign legal entities to whom the cross-border transfer of personal data is planned.
TEXT,
...
11.1. The User can receive any clarification on issues of interest regarding the processing of his personal data by contacting the Operator via email danya.shkitov@bk.ru.
TEXT,
...
11.3. The current version of the Policy is freely available on the Internet at https://klubstart.com/privacy.
TEXT,
