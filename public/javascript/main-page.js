document.addEventListener("DOMContentLoaded", function () {
    ...
    const followGrad = gradTarget.querySelector('#follow-gradient');
    const gradText = gradTarget.querySelector('#follow-gradient .grad-text');
    ...
    gradTarget.addEventListener("mousemove", function (event) {
